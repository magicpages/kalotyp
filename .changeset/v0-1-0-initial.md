...
'@magicpages/kalotyp-ghost': minor
---

First public release of Kalotyp — an MIT-licensed image editor that drops into Ghost CMS through the standard Settings → Integrations → Pintura flow.

...
import { TEXT_LINE_HEIGHT, textLines } from './text-layout.js';
...
function paintText(
  ...
  // Anchor-based, no wrapping: one line per explicit `\n`. `textAlign` on the
  // context justifies each line relative to the anchor x.
